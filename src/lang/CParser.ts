          ...
          (((_la - 36) & ~0x1f) === 0 &&
            ((1 << (_la - 36)) &
              ((1 << (CParser.Inline - 36)) |
                (1 << (CParser.Int - 36)) |
                (1 << (CParser.Long - 36)) |
                (1 << (CParser.Register - 36)) |
                (1 << (CParser.Restrict - 36)) |
                (1 << (CParser.Short - 36)) |
                (1 << (CParser.Signed - 36)) |
                (1 << (CParser.Static - 36)) |
                (1 << (CParser.Struct - 36)) |
                (1 << (CParser.Typedef - 36)) |
                (1 << (CParser.Union - 36)) |
                (1 << (CParser.Unsigned - 36)) |
                (1 << (CParser.Void - 36)) |
                (1 << (CParser.Volatile - 36)) |
                (1 << (CParser.Alignas - 36)) |
                (1 << (CParser.Atomic - 36)) |
                (1 << (CParser.Bool - 36)) |
                (1 << (CParser.Complex - 36)) |
                (1 << (CParser.Noreturn - 36)) |
                (1 << (CParser.StaticAssert - 36)) |
                (1 << (CParser.ThreadLocal - 36)) |
                (1 << (CParser.LeftParen - 36)))) !==
              0) ||
          (((_la - 80) & ~0x1f) === 0 &&
            ((1 << (_la - 80)) &
              ((1 << (CParser.Star - 80)) |
